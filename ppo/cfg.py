...
def get_cfg():
    ...
    parser.add_argument("--vessl", type=int, default=1, help="whether using vessl or not")
    ...
    parser.add_argument("--num_steps", type=int, default=50, help="Number of steps to obtain samples")
    ...
    parser.add_argument("--n_units", type=int, default=256, help="number of nodes in fully-connected layers")
